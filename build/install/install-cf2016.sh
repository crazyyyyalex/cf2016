...
/tmp/neo-security-config.sh /opt/cf2016/cfusion false

# Start up the CF server instance and wait for a moment
/opt/cf2016/cfusion/bin/coldfusion start; sleep 15
...
/opt/cf2016/cfusion/bin/coldfusion stop

# Re-enable admin security
/tmp/neo-security-config.sh /opt/cf2016/cfusion true

# Configure Apache2 to run in front of Tomcat
/opt/cf2016/cfusion/runtime/bin/wsconfig -ws Apache -dir /etc/apache2/ -bin /usr/sbin/apache2 -script /etc/init.d/apache2
